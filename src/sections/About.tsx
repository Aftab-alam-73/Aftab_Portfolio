        ...
        <div className="mt-20 flex flex-col gap-8">
          <div className=" grid grid-cols-1 gap-8 md:grid md:grid-cols-5  lg:grid-cols-3">
            ...
            <Card className="h-[320px] md:col-span-3 lg:col-span-2">
              <CardHeader
                title="My Toolbox"
                description="Explore the Technologiese and tools I use to craft exceptional digital experiences."
              />
              <ToolboxItems
                items={toolboxItems}
              ...
              <ToolboxItems
                items={toolboxItems}
                className="mt-6 animate-move-right [animation-duration:30s]"
            ...
            <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2">
              ...
              <div className="relative flex-1 " ref={constraintRef}>
                {hobbies.map((hobby) => (
                  <motion.div
                    key={hobby.title}
                    className="inline-flex  items-center  gap-2 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full p-1.5 px-6 absolute"
