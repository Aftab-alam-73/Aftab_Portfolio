    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0  overflow-x-clip">
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          I am a full-stack developer with more than one year of experience, passionate about turning ideas into fully functional, scalable web applications
          .         Let&#39;s disscus your next projects
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <Link to="projects" smooth={true} duration={500}>
            <button className="px-6  h-12  border border-white/15 rounded-xl  inline-flex items-center z-10 cursor-pointer  gap-2">
              <span className="font-semibold cursor-pointer z-10">
                Explore My work
              </span>
              <ArrowDown className="size-4 " />
            </button>
          </Link>
          <a href="./Aftab_Alam_Resume.pdf" download={"AFTAB_ALAM_RESUME"}>
            <button className="px-6  h-12  border border-white/15 rounded-xl  inline-flex items-center  gap-2">
              <span className="font-semibold cursor-pointer z-10">Resume</span>
          ...
          <button
            onClick={() =>
              (window.location.href =
                "mailto:aftabalam735530@gmail.com?subject=Project Inquiry&body=Hello, I would like to discuss a project with you.")
            }
            className="inline-flex  items-center gap-2 bg-white  text-gray-900 font-semibold border border-white cursor-pointer z-10 rounded-xl h-12 px-4 "
          >
